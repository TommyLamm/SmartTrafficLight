...
├── core.py                         # 對外 API 橋接門面
├── yolov8n.pt                      # 車輛偵測模型
├── person_wheelchair_*.pt          # 行人／輪椅偵測模型
└── smart_traffic/
...
```python
car_model    = YOLO('yolov8n.pt')                        # 車輛偵測
person_model = YOLO('person_wheelchair_*.pt')            # 行人 / 輪椅偵測
```
