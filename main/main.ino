...
//
//  Traffic LEDs  — Pins 2-7  (RGB for Car + Pedestrian)
...
// ─────────────────────────── RFID UIDs ──────────────────────
// Add the 4-byte UIDs of your emergency-vehicle RFID tags here.
const byte EMERGENCY_UIDS[][4] = {
  { 0xDE, 0xAD, 0xBE, 0xEF },   // Tag 1 — replace with real UID
  { 0xCA, 0xFE, 0xBA, 0xBE }    // Tag 2 — replace with real UID
};
const int NUM_EMERGENCY_TAGS = 2;
